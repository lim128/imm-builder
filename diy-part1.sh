...
git clone --depth 1 -b v5 --single-branch https://github.com/sbwml/openwrt_helloworld.git package/helloworld && rm -rf package/helloworld/{lua-neturl,luci-app-homeproxy}

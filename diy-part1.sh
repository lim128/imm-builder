...
git clone --depth 1 -b v5 --single-branch https://github.com/sbwml/openwrt_helloworld.git package/helloworld && rm -rf package/helloworld/{luci-app-homeproxy,lua-neturl,dae,daed}
